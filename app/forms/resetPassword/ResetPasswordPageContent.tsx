...
export default function ResetPasswordPageContent() {
  ...
  if (!appConfig?.openLogin) {
    return (
      <main className="mx-auto max-w-5xl px-4 py-12">
        <div className="mx-auto max-w-[520px] rounded-xl border border-zinc-300 bg-white p-6 text-center">
  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-12">
      <ResetPasswordForm appName={appConfig.appName} brandLogoUrl={appConfig.brandLogoUrl} />
    </main>
  );
}
